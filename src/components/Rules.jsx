...
export default function Rules({ data, save, showToast }) {
  ...
  const RULES = [
    'מקסימום 5 עסקאות בשבוע',
    'מקסימום 2 עסקאות ביום',
    '3 הפסדים בשבוע = עצירה עד שבוע הבא',
    'כל עסקה היא 2R בלבד',
    'אין Home Run',
    'אני מודד את עצמי ב-R, לא בפיפס',
  ...
  const MORNING = [
    ...
    'הפסד הוא חלק מהמשחק',
    '2R מספיק לי',
    'ארבע עסקאות טובות שוות יותר מעשרים בינוניות',
  ...
  const WEEKS = [
    { title: 'שבוע 1 — ניקוי הראש', desc: 'להפסיק לפעול מתוך הכאב. לא מפקיד. עד 5 עסקאות. 2R קבוע. לא מסתכל אחורה.', mantra: '"אני לא מתקן את העבר. אני מבצע את ההווה."' },
    ...
    { title: 'שבוע 3 — אימון על סבלנות', desc: 'אם אין setup ברמה גבוהה — לא סוחרים. שבוע ללא עסקאות = הצלחה אם שמרת על החוקים. 5 עסקאות זה תקרה, לא יעד.', mantra: '"0 עסקות + 0 חריגות = שבוע מושלם."' },
